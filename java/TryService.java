...
private DatabaseReference mDatabase;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if(!isStarted){
            ...
            mDatabase = FirebaseDatabase.getInstance("https://horapp-68eec-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("Users/notification");
...
//        });
    ...
    public void onDestroy() {
        ...
        mDatabase.removeEventListener(serviceListener);
    }
