...
//        chatBar.setText(extras.getString("otherUser"));
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // chatAdapter.add(new ChatUser("lili",chatInput.getText().toString()));
                //chat.add(new ChatUser("lili",chatInput.getText().toString(),"me"));
                //chatAdapter.notifyDataSetChanged();
